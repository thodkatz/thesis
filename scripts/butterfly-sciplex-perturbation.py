...
def main():
    scbutterfly.run_sciplex3("ellagic_acid", dataset1)
    scbutterfly.run_sciplex3("dival_sodium", dataset2)
    
def main_no_reusing():
    scbutterfly.run_sciplex3_no_reusing("ellagic_acid_no_reusing", dataset1)
    scbutterfly.run_sciplex3_no_reusing("dival_sodium_no_reusing", dataset2)
