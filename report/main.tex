...
Some ideas mentioned initially to improve \verb|UnitedNet| \fullref{sec:improvements}, such as a) making use of validation sets for early stopping, b) using variants of autoencoders such as variational ones, c) learning the coefficients of the losses, we can see that they are applied by the \verb|scButterfly| framework.
